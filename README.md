...
C4Container
    ...
    Rel(triage, tech, "Routes technical intent")
    Rel(triage, billing, "Routes billing intent")
    Rel(triage, escalate, "Routes escalations")
    Rel(tech, fusion, "Queries KB", "Internal Async")
    Rel(billing, fusion, "Queries KB", "Internal Async")
    Rel(fusion, chroma, "Dense Search")
    Rel(fusion, bm25, "Lexical Search")
    Rel(tech, sqlite, "Checkpoints state on node exit")
    Rel(billing, sqlite, "Checkpoints state on node exit")
